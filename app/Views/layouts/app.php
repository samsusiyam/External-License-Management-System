...
<div class="elms-layout">
    ...
    <aside class="elms-sidebar" id="elmsSidebar">
        ...
        <nav class="nav flex-column">
            ...
            <div class="elms-nav-label">Help &amp; Guides</div>
            <a class="nav-link <?= (str_contains($path, '/admin/docs') && !str_contains($path, 'whmcs')) ? 'active' : '' ?>" href="<?= $base ?>/admin/docs?doc=guide"><i class="bi bi-book"></i>API Docs</a>
            <a class="nav-link <?= (str_contains($path, '/admin/docs') && str_contains($path, 'whmcs')) ? 'active' : '' ?>" href="<?= $base ?>/admin/docs?doc=whmcs"><i class="bi bi-file-earmark-code"></i>WHMCS Guide</a>
        </nav>
