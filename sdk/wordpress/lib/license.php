 ...
 *  - Verified server response signatures (MITM protection)
 *  - Local signed response caching to reduce calls and tolerate outages
...
class ElmsLicense
{
    ...
    /**
     * @param array{server:string,api_key:string,secret:string,product?:string,cache_dir?:string,cache_ttl?:int,signature_max_skew?:int} $config
     */
